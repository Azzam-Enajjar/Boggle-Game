...
public class MultiplayerNormal extends ActionBarActivity {
...
//        boggle.setVisibility(View.INVISIBLE);
    ...
    public class CountDownTimerActivity extends CountDownTimer {
        ...
        public void onFinish() {
            ...
            Intent i = new Intent(MultiplayerNormal.this, MultiplayerScore.class);
...
/*          new Handler().postDelayed(new Runnable() {
                public void run() {
                    Intent i = new Intent(MultiplayerNormal.this, scoreBoard.class);
                    startActivity(i);
